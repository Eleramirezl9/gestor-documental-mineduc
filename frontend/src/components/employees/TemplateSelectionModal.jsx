...
import { Package, X, FileText, Users, Briefcase, GraduationCap, Heart, Calculator } from 'lucide-react';

const TemplateSelectionModal = ({ open, onOpenChange, templates, onSelectTemplate, onCreateNew }) => {
